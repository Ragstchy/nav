...
const c: IConfig = {
  ...
  // 网站关键字
  keywords: '电商先锋，查黑号，查降权黑号，创客照妖镜,淘宝查号,先锋小助手,宝贝排名查询,指数转换工具,淘宝数据分析工具,淘宝排行榜流量查询,天猫淘宝店铺关注，电商资源，好物点评，问大家置顶，店铺上钻，淘宝改销量',
  ...
  simThemeConfig: {
    ...
    description: '这里收录多达 <b>${total}</b> 个优质网站， 助您运营店铺，工作、更进一步'
  }
}
